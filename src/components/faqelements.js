			...
			<Accordion open={open === 4}>
				...
				<AccordionBody className='AccDescription'>
					<ul class='list-inside list-disc'>
						...
						<li>
							Сообщить специалисту о всех проблемах здоровья и
							противопоказаниях. Некоторые заболевания, такие как диабет,
							аллергии или проблемы с сердечно-сосудистой системой, могут
							повлиять на процедуру электроэпиляции.
						</li>
					</ul>
				</AccordionBody>
			</Accordion>
