			...
			<div className='px-5 pt-10'>
				...
				<div className='columns-1'>
					...
					{isLoading && (
						...
						<div>
							<div
								className='w-full mt-5 rounded-xl bg-gradient-to-r from-yellow-300 to-yellow-700 animate-pulse'
								style={{ height: '200px' }}
							></div>
							<div
								className='w-full mt-5 rounded-xl bg-gradient-to-r from-yellow-700 to-yellow-300 animate-pulse'
								style={{ height: '200px' }}
							></div>
						</div>
					)}
